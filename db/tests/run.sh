...
FILES=()
for f in db/tests/t_seed.sql db/tests/t_rls.sql db/tests/t_viste.sql db/tests/t_messaggi.sql db/tests/t_report.sql db/tests/t_conversazioni.sql db/tests/test_zero_scritture.sql; do
