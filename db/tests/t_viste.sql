...
DECLARE attesi text[][] := ARRAY[
  ...
  r text[]; v text;
BEGIN
  -- Il totale dei parametri NON è asserito: una sessione sorella può aggiungerne (l'US-4 qui
  -- sopra è il caso concreto) e un conteggio esatto è diventato rosso senza che il contratto
  -- fosse cambiato. Ciò che conta è che i parametri del contratto esistano con i valori attesi:
  -- è il ciclo FOR-EACH qui sotto, non il totale.
