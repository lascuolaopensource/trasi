...
| **Movimento attrezzoteca (prestito tra Case)** | È un evento operativo concordato tra due Case, non una modifica di scheda: la tutela V4 è garantita dalla **decisione della controparte** (`conferma_movimento`: dal 2026-09-18, db/033, il movimento può proporsi anche dalla ricevente come richiesta, e decide chi non l'ha proposto — conferma o rifiuto) e dall'audit su ogni passaggio di stato. |
